...
class MainWindow(CTkToplevel):
    def __init__(self, master, settings : Settings, pipeline_prcess : PipelineProcess):
        ...
        self.audio_player_frame = AudioPlayerFrame(self.right_sidebar_frame, 1, 0, settings)   
        ...
        self.init_pipeline_frame = InitPipelineFrame(self.left_sidebar_frame, 0, 0, self.thread_manager.init_pipeline_queue)             
    ...
    def on_process_state_change(self, old_process_state : ProcessState, process_state : ProcessState, trim_enabled : bool, forced : bool):
        self.thread_manager.on_process_state_change(old_process_state, process_state,  trim_enabled, forced)
