...
class AudioPreviewFrame(CTkFrame):
    def __init__(self, parent, row, column, settings : Settings,
        ...
        self.trim_settings_frame = TrimSettingsFrame(self, row=1, column=0, settings=settings)
        
        self.original_label = CTkLabel(self, text="Hangfájl:", height=10, font=label_font())
        self.original_label.grid(row=2, column=0, padx=20, pady=(10,2), sticky='sw')
        ...
        self.original_textbox.grid(row=3, column=0, padx=15, pady=(0, 10), sticky='nsew')

        self.split_label = CTkLabel(self, text="Szegmensek:", height=10, font=label_font())
        self.split_label.grid(row=4, column=0, padx=(20, 0), pady=(0,2), sticky='sw')
        ...
        self.split_delete_all_button.grid(row=4, column=0, padx=(0, 20), pady=(0,2), sticky="se")
        ...
        self.split_delete_selected_button.grid(row=4, column=0, padx=(0, 55), pady=(0,2), sticky="se")
        ...
        self.split_textbox.grid(row=5, column=0, padx=15, pady=(0, 10), sticky='nsew')

        self.trim_label = CTkLabel(self, text="Vágott szegmensek:", height=10, font=label_font())
        self.trim_label.grid(row=6, column=0, padx=20, pady=(0,2), sticky='sw')
        ...
        self.trim_delete_all_button.grid(row=6, column=0, padx=(0, 20), pady=(0,2), sticky="se")
        ...
        self.trim_delete_selected_button.grid(row=6, column=0, padx=(0, 55), pady=(0,2), sticky="se")
        ...
        self.trim_textbox = AudioInteractiveTextbox(self.trimmed_audio_manager, audio_load_callback=audio_load_callback,
                                            ...
                                            audio_play_callback=audio_play_callback, master=self)
        self.trim_textbox.grid(row=7, column=0, padx=15, pady=(0, 10), sticky='nsew')
